<div id="content">
  ...
  <div id="content-header">
    ...
    <h1>Zoning Application Reports <a href="<?php echo base_url(); ?>/dashboard/get_employees_accomplishment_report_info" class="btn btn-success"><i class="icon-print"></i> Print Numerical</a> <button class="btn btn-primary"><i class="icon-print"></i> Print Graphical</button></h1>
    <hr style="margin:10">
  </div>
  <!--End-breadcrumbs-->
      ...
      <div class="span12">
        <div class="widget-box" style="background-color: #fff">
          <div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5>Issued Zoning Clearance by Year</h5>
          </div>
      ...
      <div class="span12">
        <div class="widget-box" style="background-color: #fff">
          ...
          <div class="widget-content no-padding">
            <div class="row-fluid">
              <div class='span12'>
                <div id="organization-container" style="height: 400px; width: 100%;"></div>
                <div style="background-color: #fff; height: 25px; width: 100px; position: absolute; bottom: 15px"> </div>
              </div>
            </div>
          </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
     ...
     var chart = new CanvasJS.Chart("chartContainer", {
      title: {
        text: "Issued Zoning Clearance Year <?= date('Y') ?>"
      },
     ...
     var chart = new CanvasJS.Chart("organization-container", {
      title: {
      ...
      data: [{
        type: "column",
        dataPoints: [
        { y: <?= $single ?>, label: "Single" },
        { y: <?= $partnership ?>, label: "Partnership" },
        { y: <?= $corporation ?>, label: "Corporation" },
        { y: <?= $cooperative ?>, label: "Cooperative" },
        ]
      }]
    });
