															...
															<div class="col-sm-12">
																...
																<div class="row">
																	<div class="col-sm-5">
																		...
																		<div class="checkbox">
																			<label><input type="checkbox" id="fugitive-particulate-dust" name="fugitive-particulates[]" value="Dust"><strong>Dust</strong></label>
																		</div>
																		<div class="checkbox">
																			<label><input type="checkbox" id="fugitive-particulate-mist" name="fugitive-particulates[]" value="Mist"><strong>Mist</strong></label>
																		</div>
																		<div class="checkbox">
																			<label><input type="checkbox" id="fugitive-particulate-gas" name="fugitive-particulates[]" value="Gas"><strong>Gas</strong></label>
																		</div>
																	</div>
																	<div class="col-sm-5">
																		<span>Steam Generator:</span>
																		<div class="checkbox">
																			<label><input type="checkbox" id="steam-generators-bioler" name="steam-generators[]" value="Boiler"><strong>Boiler</strong></label>
																		</div>
																		<div class="checkbox">
																			<label><input type="checkbox" id="steam-generators-furnace" name="steam-generators[]" value="Furnace"><strong>Furnace</strong></label>
																		</div>
																		<div class="checkbox">
																			<label><input type="checkbox" id="steam-generators-others" name="steam-generators[]" id="steam-generator-others" value="" ><strong>Others</strong></label>
																...
																<div class="row">
																	<div class="col-sm-4">
																		...
																		<select name="air-pollution-control-devices" id="air-pollution-control-devices" required class="form-control">
																			...
																			<option value="Mercury Control Technology">Mercury Control Technology</option>
																			<option value="Particulate Control Systems">Particulate Control Systems</option>
																			<option value="Wet Flue Gas Desulfurization System">Wet Flue Gas Desulfurization System</option>
																			...
																			<option value="Pulse-Jet Baghouse">Pulse-Jet Baghouse</option>
																			<option value="Selective Catalytic Reduction (SCR) System">Selective Catalytic Reduction (SCR) System</option>
																			<option value="CO2 Capture">CO2 Capture</option>
																		</select>
																	</div>
																	<div class="col-sm-4">
																		<label for="stack-height">Stack Height</label>
																		<input type="number" placeholder="0" required name="stack-height" id="stack-height" class="form-control">
																	</div>
																</div>
																<!-- END AIR POLLUTION -->
																<hr>
																...
																<div class="row">
																	<div class="col-sm-4 ">
																		...
																		<option disabled selected>Select Wastewater Treatment Facility</option>
																			<option value="None">None</option>
																			<option value="August 10 Enterprises">August 10 Enterprises</option>
																			<option value="Bayer CropScience, Inc.">Bayer CropScience, Inc.</option>
																			<option value="D.H. Lijauco Enterprises">D.H. Lijauco Enterprises</option>
																			<option value="ELMS Industrial (Philippines) Co., Inc.">ELMS Industrial (Philippines) Co., Inc.</option>
																			<option value="Environmental Solutions Philippines (ESPHIL), Inc.">Environmental Solutions Philippines (ESPHIL), Inc.</option>
																			<option value="FRILCO Philippines Corporation">FRILCO Philippines Corporation</option>
																			<option value="HAZCHEM, Inc.">HAZCHEM, Inc.</option>
																			<option value="HMR Envirocycle Phils., Inc. (HEPI)">HMR Envirocycle Phils., Inc. (HEPI)</option>
																			<option value="Intergrated Recycling Industries Phils., Inc. (IRIPI)">Intergrated Recycling Industries Phils., Inc. (IRIPI)</option>
																			<option value="Maritrans Recycler, Inc.">Maritrans Recycler, Inc.</option>
																			<option value="Mary Check Trading">Mary Check Trading</option>
																			<option value="SEMICYTECH., Inc.">SEMICYTECH., Inc.</option>
																			<option value="Symmetrical Maintenance and General Services">Symmetrical Maintenance and General Services</option>
																			<option value="The Rock Environmental Approach Technologies (TREAT), Inc.">The Rock Environmental Approach Technologies (TREAT), Inc.</option>
																			<option value="TMC Metal Philippines, Inc.	">TMC Metal Philippines, Inc.</option>
																		</select>
																	</div>
																</div>
																	...
																	<div class="col-sm-4">
																		<div class="form-group">
																			...
																			<option selected disabled>Select Type of Solid Wastes Generated</option>
																				<option value="Household/Municipal Solid Wastes">Household/Municipal Solid Wastes</option>
																				<option value="Industrial/Hazardous Wastes">Industrial/Hazardous Wastes</option>
																				<option value="Biomedical/Hospital Wastes">Biomedical/Hospital Wastes</option>
																			</select>
																		</div>
																	</div>
																	<div class="col-sm-2">
																	...
																	<div class="col-sm-4">
																		<div class="form-group">
																			...
																			<option selected disabled>Select Method of Garbage Collection</option>
																				...
																				<option value="AutoBins">AutoBins</option>
																				<option value="Automated Cart Collection">Automated Cart Collection</option>
																				<option value="Bulky Waste Pickup">Bulky Waste Pickup</option>
																			</select>
																		</div>
																	</div>
																</div>
																...
																<div class="row">
																	<div class="col-sm-12">
																		<div class="form-group">
																			...
																			<div class="radio-inline">
																				<label><input type="radio" checked name="garbage-disposal-method" id="sanitary-landfill" value="Sanitary Landfill"><strong>Sanitary Landfill</strong></label>
																			</div>
																			<div class="radio-inline">
																				<label><input type="radio" id="controlled-dumpsite" name="garbage-disposal-method" value="Controlled Dumpsite"><strong>Controlled Dumpsite</strong></label>
																			</div>
																		</div>
																	</div>
																</div>
																	...
																	<div class="col-sm-12">
																		<div class="form-group">
																			...
																			<div class="checkbox-inline">
																				<label><input type="checkbox" name="waste-minimization[]" value="Recycling" id="recycling"><strong>Recycling</strong></label>
																			</div>
																			<div class="checkbox-inline">
																				<label><input type="checkbox" name="waste-minimization[]" value="Reduction" id="reduction"><strong>Reduction</strong></label>
																			</div>
																			<div class="checkbox-inline">
																				<label><input type="checkbox" name="waste-minimization[]" value="Reuse" id="reuse"><strong>Reuse</strong></label>
																			</div>
																		</div>
																	</div>
																</div>
																...
																<div class="row">
																	...
																	<div class="row">
																		<div class="col-sm-3">
																			<div class="radio">
																				<label><input type="radio" checked name="water-supply" id="deep-well" value="Deep Well"><strong>Deep Well</strong></input></label>
																			</div>
																		</div>
																		<div class="col-sm-3">
																			<div class="radio">
																				<label><input type="radio" name="water-supply" id="local-water" value="Water Utility"><strong>Local Water Utility</strong></input></label>
																			</div>
																		</div>
																		<div class="col-sm-3">
																			<div class="radio">
																				<label><input type="radio" name="water-supply" id="surface-water" value="Surface Water"><strong>Surface Water</strong></input></label>
																			</div>
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-sm-3">
																			<div class="form-group">
																				...
																				<select name="water-supply-type" id="water-supply-type" class="form-control">
																					...
																					<option value="Piped Water into Dwelling">Piped Water into Dwelling</option>
																					<option value="Piped Water into Yard/Plot">Piped Water into Yard/Plot</option>
																					<option value="Public Tap/Standpipes">Public Tap/Standpipes</option>
																					<option value="Tubewell/Boreholes">Tubewell/Boreholes</option>
																					<option value="Protected Dug Wells">Protected Dug Wells</option>
																					<option value="Protected Springs">Protected Springs</option>
																	...
																	<div class="col-sm-8 col-sm-offset-2">
																		<table id='bus-activity' class="table table-bordered">
																			...
																			<tbody class="table-body">
																				<tr class="data">
																					<td>
																						<select name='line-of-business' id='line-of-business' required class="form-control sel-line-of-business bus-activity">
